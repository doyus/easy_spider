"""
Django settings for gxadmin project.
...
# 如果需要在跨域请求中发送认证信息（如 Cookies），可以启用以下设置：
CORS_ALLOW_CREDENTIALS = True


ROOT_URLCONF = 'gxadmin.urls'
...
WSGI_APPLICATION = 'gxadmin.wsgi.application'
