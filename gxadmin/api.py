...
from gxspider.router import gxspider_router
from gxtask.router import gxtask_router
...
api.add_router('/gxtask/', gxtask_router)
api.add_router('/gxspider/', gxspider_router)
